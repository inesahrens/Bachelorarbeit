...
Zunächst ist es wichtig, dass $u_0$ an beiden Rändern unterschiedlich ist. Wenn $u_0$ an beiden Rändern gleich ist, ist die Verschiebung des Materials überall gleich, d.h. das Material   

\paragraph{$u_0$ ist konstant und der Riss ist durchgängig}

\paragraph{$u_0$ ist konstant und der Riss ist nur an einem Rand}

\paragraph{$u_0$ ist konstant und der Riss ist in der Mitte}

\paragraph{$u_0$ ist konstant und der Riss ist an beiden Rändern}

\paragraph{$u_0$ ist linear und der Riss ist durchgängig}

\paragraph{$u_0$ ist linear und der Riss ist nur an einem Rand}

\paragraph{$u_0$ ist linear und der Riss ist an beiden Rändern}

\paragraph{$u_0$ ist linear und der Riss ist in der Mitte}

\paragraph{$u_0$ ist entgegengesetzt linear und der Riss ist durchgängig}
...
\paragraph{$u_0$ ist entgegengesetzt linear und der Riss ist an beiden Rändern}

\paragraph{$u_0$ ist eine parabel an beiden Seiten und der Riss ist durchgängig}

\paragraph{$u_0$ ist eine seite linear und andere konstant}


\begin{itemize}
	\item stärkere Einsicht in die vorher beschriebenen Numerischen Methoden
	\begin{itemize}
		\item noch keine ahnung
	\end{itemize}
	\item Verifizierung Theoretischer Aussagen
	\begin{itemize}
		\item Konvergiert die Newtonmethode? deformation wird ziemlich ähnlich, obwohl riss einmal am anfang als loch und ein anderes mal als kompletter Riss gegeben; Riss sieht auch ähnlich aus, nur dass beim mittleren Riss der Riss wirklich in der Mitte geblieben ist und beim Loch an eine Seite gewandert ist. 
		\item vll auch, dass einige vorraussetzungen nicht gebraucht werden? eher unwichtig!
	\end{itemize}
\end{itemize}


Falls u an beiden Seiten auf unterschiedlicher aber jeweils konstanter Höhe eingespannt ist und ein Riss in der Mitte des Materials entsteht, sehen wir die Unstetigkeitsstelle genau an dem Riss. 
Unterschiedliche Gitterweiten?

Falls wir $u$ nicht konstant einspannen, also an beiden Seiten schräg, aber gleiche Höhe
Unterschiedliche Gitterweiten?

schräg aber unterschiedliche Höhe
unterschiedliche Gitterweiten
