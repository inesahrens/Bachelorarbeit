...
Nun haben wir die Bedingungen gegeben, sodass wir von  \eqref{eq:optimierungsproblem_raumbedingung} das KKT System aufstellen können. Dabei ist $\overline{w}$ die Lösung des Problems. $\mu$ und $\lambda$ heißen Lagrange Multiplikatoren. 
\begin{align*}
	\begin{array}{lll}
...
\subsection{Newton Methoden ohne Nebenbedingungen}
...
\begin{defi}[Regularitätsannahme für semidifferenzierbare Newton Verfahren]
