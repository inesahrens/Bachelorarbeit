function [A, B, c, D] =  Matrixes_for_G(u, edges, allSurroundingTriangles, m, n )
...
%gebraucht werden, außer e. 
    ...
    % c = \int\Omega T_i dx
    c = integrate_ti(allSurroundingTriangles, m, n);  
...
%integrate_ti berechnet \int_\Omega ti dx 
    result = zeros((n+1)*(m+1),1); 
    
    % Zur berechnung des Integrals wird immer über alle anliegenden
    % Dreiecke integriert. Es gilt \int_E T_i dx= 1/6 für alle i und alle
    % Dreiecke. Also müssen die vorhandenen Dreiecke nur summiert und mit
